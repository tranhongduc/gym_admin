...
const ViewExecrise = () => {
  ...
  const getListData = async () => {
    try {
      const a = await getExerciseByID(id);
      console.log("a", a);
  ...
  return (
    <Box m="20px">
      <Header
        title="Execise Information"
        subtitle="Managing the Execise Information"
      />
        ...
        >
          {isEditMode ? (
            ...
            <Typography color={colors.grey[100]} fontWeight="bold">
              ...
              {userData?.goal === "fat_loss" && "Fat Loss"}
        ...
        >
          {isEditMode ? (
            ...
            >
              ...
              {userData?.activityLevel === "medium" && "Medium"}
